...
func _register_project_settings() -> void:
	...
	_set_setting("ai/generation/router_system_prompt", "", "Router system prompt override", TYPE_STRING, PROPERTY_HINT_MULTILINE_TEXT)
	_set_setting("ai/generation/analyst_system_prompt", "", "Analyst system prompt override", TYPE_STRING, PROPERTY_HINT_MULTILINE_TEXT)
	_set_setting("ai/generation/technician_system_prompt", "", "Technician system prompt override", TYPE_STRING, PROPERTY_HINT_MULTILINE_TEXT)
