...
static func get_tool_definitions(enable_docs: bool, enable_resources: bool, enable_modify: bool = false, enable_validate: bool = false, enable_execute: bool = false, enable_capture: bool = false, enable_hierarchy: bool = false, enable_todo: bool = false, enable_search: bool = false, enable_web_search: bool = false, enable_read_webpage: bool = false) -> Array[Dictionary]:
